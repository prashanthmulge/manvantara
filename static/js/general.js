...
function slideShow() {
  ...
  function maxSlideWidth() {
    ...
    return globals.slideImages[maxSlideIndex].getBoundingClientRect().width + 400; // Account for the image's border, padding, and margin values. Note that getBoundingClientRect() is always in units of pixels.
  } // maxSlideWidth
...
function loadheader() {
	document.getElementById("header").innerHTML='<object type="text/html" data="../../static/header.html" ></object>';
}